...
FormularioReporteCatastral.propTypes = {
    functionBuscarExpedientes: PropTypes.func,
    propFunctionCloseModal: PropTypes.func,
}


function FormularioReporteCatastral( { functionBuscarExpedientes, propFunctionCloseModal } ) {
    ...
    function handleSubmit() {
        executePost(token, 'https://apiv1.deltapro.com.co/deltacu/reports/catastro/', dataPost)
    }
    ...
    return (
        <ModalBasicNew title='Reporte Catastral' propFunctionCloseModal={propFunctionCloseModal}>
            <BoxContainerInputsByInfoBigScroll>
            <div className='formulario-reporte-catastral'>
...
export default FormularioReporteCatastral
